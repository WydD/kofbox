...
void __stdcall NativeInjectionEntryPoint(REMOTE_ENTRY_INFO *inRemoteInfo) {
    ...
    BYTE attackHitCheckPattern[] = {
            0x48, 0x89, 0x5C, 0x24, 0x08, 0x48, 0x89, 0x6C, 0x24, 0x18, 0x48, 0x89, 0x74, 0x24, 0x20, 0x57, 0x41, 0x56,
            0x41, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0, 0, 0, 0, 0, 0x4C, 0x8B, 0xF9, 0x48, 0x85, 0xC0, 0x75, 0x1E
    };
    ...
    AttackHitCheck = (void (*)(void *)) findPointer(attackHitCheckPattern, sizeof(attackHitCheckPattern), &moduleInfo, 26, 31);
